...
import './lib/index.js?v=30';
import Terminal from './terminal.js?v=30';
import BootManager from './boot-manager.js?v=30';
import StorageService from './storage.js?v=30';
import UserManager from './user-manager.js?v=30';
import Dialogs from './dialogs.js?v=30'; // 会自动把 Dialogs 类挂到 window.Dialogs，供 iframe 应用调用文件选择器
